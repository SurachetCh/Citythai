...
import revenue_express.citythai.adapter.WriteReviewsMenuAdapter;
import revenue_express.citythai.adapter.WriteReviewsSetImageAdapter;
import revenue_express.citythai.dao.WriteReviewsMenuDataDao;
import revenue_express.citythai.dao.WriteReviewsSetImageDataDao;
...
public class WriteReviewsActivity extends AppCompatActivity implements Spinner.OnItemSelectedListener{
    ...
    TextView tv_title_head,tvShopName,tv_display_title,tv_display_des,tv_display_score,tv_display_price,tv_display_recommend_menu,tv_display_upload_image;
    Button btnSend;
...
//Set type fonts
    ...
    private void setColor(){
        btnSend.setBackgroundColor(Color.parseColor(SplashScreen.ColorPrimary));
        tv_title_head.setTextColor(Color.parseColor(SplashScreen.TextColorPrimary));
        tvShopName.setTextColor(Color.parseColor(SplashScreen.TextColorPrimary));
        btnSend.setTextColor(Color.parseColor(SplashScreen.TextColorPrimary));
    }
    ...
    //Dropdown select menu recommend foods
    ...
    //remove list menu recommend image
